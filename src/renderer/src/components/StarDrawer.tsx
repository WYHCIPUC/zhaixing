...
export default function StarDrawer({
  ...
  return (
    <motion.div
      ...
      className="absolute right-0 top-0 z-30 flex h-full w-[400px] max-w-[45vw] flex-col overflow-hidden border-l border-[var(--line)] bg-[#0b1120f5]"
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
        ...
        />
        {socratic && (
          <div className="mt-2 rounded-lg border border-[rgba(167,139,250,0.35)] bg-[rgba(167,139,250,0.08)] px-3 py-2 text-[12px] italic text-[#c4b5fd]">
            苏格拉底问：{socratic}
        ...
        {rewriteText && (
          <div className="mt-2 rounded-lg border border-[var(--line)] bg-black/20 px-3 py-2 text-[12.5px] leading-6">
          ...
          {links
            ...
            .map((l) => {
              ...
              return (
                <button
                  key={l.id}
                  className="block w-full rounded-lg border border-[var(--line)] px-3 py-2 text-left transition-colors hover:border-[rgba(125,211,252,0.4)]"
                  onClick={() => onJump(o.id)}
                >
        ...
        {linkSearch && (
          <div className="mt-2 space-y-1.5">
            {linkSearch.map((h) => (
              <button
                key={h.highlight_id}
                className="block w-full rounded-lg border border-[var(--line)] px-3 py-1.5 text-left text-[12px] hover:border-[rgba(125,211,252,0.4)]"
